...
export async function createTemporaryGantteeDocument(content: string): Promise<vscode.Uri> {
...
export async function deleteTemporaryGantteeDocument(uri: vscode.Uri): Promise<void> {
