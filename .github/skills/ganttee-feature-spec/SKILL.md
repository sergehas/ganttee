...
1. Copy the [spec template](./assets/feature-spec-template.md) into `docs/specs/<feature-slug>.md`
...
6. Sync status badge with front matter `Status`: place the mapped badge directly under
   `# Feature: <name>` and update it whenever `Status` changes.
7. Hand the finished spec to the **Test Planner** agent for a coverage plan and to the
